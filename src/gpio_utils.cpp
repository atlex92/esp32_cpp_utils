...
esp_err_t GpioUtils::setGpioMode(const gpio_num_t gpio, const gpio_mode_t mode, const bool pullup,
                                 const bool pulldown) {
...
esp_err_t GpioUtils::setGpioModeForGroup(const uint64_t gpio_bitmask, const gpio_mode_t mode, const bool pullup,
                                         const bool pulldown) {
  const gpio_config_t conf{.pin_bit_mask = gpio_bitmask,
                           .mode = mode,
