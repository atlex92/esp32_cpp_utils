...
public:
  explicit AdcAsyncChannel(const uint32_t period_ms, const adc_unit_t unit, const adc_channel_t channel,
                           const adc_bitwidth_t bitwidth, const adc_atten_t attenuation)
  : Task{"AsyncAdcChannel", configMINIMAL_STACK_SIZE * 2}, adc_channel_{unit, channel, bitwidth, attenuation},
