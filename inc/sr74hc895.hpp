...
public:
    ...
    explicit Sr74hc595(const gpio_num_t clk_gpio, const gpio_num_t data_gpio, const gpio_num_t latch_gpio, const gpio_num_t oe_gpio, const gpio_num_t reset_gpio)
